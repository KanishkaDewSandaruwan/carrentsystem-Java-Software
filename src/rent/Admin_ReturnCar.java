 ...
 * @author kaniya
 */
public class Admin_ReturnCar extends javax.swing.JFrame {

    /**
     * Creates new form CarReg
     */
    public Admin_ReturnCar() {
        initComponents();
...
//        txtDate.setDateFormatString("yyyy/MM/dd");
    ...
    private void table2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table2MouseClicked
        ...
        try {
            ...
            Logger.getLogger(Admin_ReturnCar.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(Admin_ReturnCar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_ReturnCar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_ReturnCar().setVisible(true);
            }
        });
    }
